    ...
    public class ShipmentTrackingController : Controller
    {
        ...
        public async Task<IActionResult> AddTracking(CreateShipmentTrackingDto createDto)
        {
            ...
            return RedirectToAction("Index",
                new { trackingNumber = createDto.TrackingNumber });
        }

        // GET: /ShipmentTracking/UpdateTracking?trackingNumber=TRK-ABC123&index=0
        [HttpGet]
        ...
        public async Task<IActionResult> UpdateTracking(UpdateShipmentTrackingDto updateDto)
        {
            if (!ModelState.IsValid)
            {
                var shipment = await _shipmentService.GetShipmentByTrackingNumberAsync(updateDto.TrackingNumber);
        ...
        // GET: /ShipmentTracking/DeleteTracking?trackingNumber=TRK-ABC123&index=0
